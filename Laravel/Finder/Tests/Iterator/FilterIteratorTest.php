...
namespace Laravel\Finder\Tests\Iterator;
...
class FilterIteratorTest extends RealIteratorTestCase
{
    public function testFilterFilesystemIterators()
    {
        ...
        $i = $this->getMockForAbstractClass('Laravel\Finder\Iterator\FilterIterator', array($i));
        $i->expects($this->any())
            ->method('accept')
        ...
        // but works with Laravel\Finder\Iterator\FilterIterator

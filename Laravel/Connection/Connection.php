...
use Laravel\Query\Expression;
//use Illuminate\Contracts\Events\Dispatcher;
use Laravel\QueryException;
use Laravel\Query\Processors\Processor;

use Laravel\Query\Builder as QueryBuilder;
use Laravel\Schema\Builder as SchemaBuilder;
use Laravel\Query\Grammars\Grammar as QueryGrammar;
...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var \Laravel\Query\Grammars\Grammar
     */
     ...
     *
     * @var \Laravel\Schema\Grammars\Grammar
     */
     ...
     *
     * @var \Laravel\Query\Processors\Processor
     */
     ...
     *
     * @return \Laravel\Query\Grammars\Grammar
     */
     ...
     *
     * @return \Laravel\Schema\Grammars\Grammar
     */
     ...
     *
     * @return \Laravel\Query\Processors\Processor
     */
     ...
     *
     * @param  mixed  $value
     * @return \Laravel\Query\Expression
     */
     ...
     *
     * @param  \Laravel\QueryException  $e
     * @param  string    $query
     * @param  array     $bindings
     * @param  \Closure  $callback
     * @return mixed
    ...
    {
        return false;//class_exists('Doctrine\DBAL\Connection');
    }
     ...
     *
     * @param  \Laravel\Query\Grammars\Grammar  $grammar
     * @return void
     */
    public function setQueryGrammar(\Laravel\Query\Grammars\Grammar $grammar)
    {
     ...
     *
     * @param  \Laravel\Schema\Grammars\Grammar  $grammar
     * @return void
     */
    public function setSchemaGrammar(\Laravel\Schema\Grammars\Grammar $grammar)
    {
     ...
     *
     * @param  \Laravel\Query\Processors\Processor  $processor
     * @return void
     */
     ...
     *
     * @return \Laravel\Events\Dispatcher
     */

...
use Laravel\Pagination\Paginator;
use Laravel\Support\Traits\Macroable;
use Laravel\Contracts\Support\Arrayable;
use Laravel\Connection\ConnectionInterface;
use Laravel\Query\Grammars\Grammar;
use Laravel\Pagination\LengthAwarePaginator;
...
class Builder
{
     ...
     *
     * @var \Laravel\Connection\Connection
     */
     ...
     *
     * @param  \Laravel\Connection\ConnectionInterface  $connection
     ...
     * @return \Laravel\Query\Builder|static
     */
     ...
     *
     * @param  \Closure|\Laravel\Query\Builder|string $query
     * @param  string  $as
     * @return \Laravel\Query\Builder|static
     *
     ...
     *
     * @param  \Laravel\Query\Builder|static $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     * Add an exists clause to the query.
     *
     * @param  \Laravel\Query\Builder $query
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  \Laravel\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return \Laravel\Query\Builder|static
     */
     ...
     *
     * @param  array  $columns
     * @return \Laravel\Support\Collection
     */

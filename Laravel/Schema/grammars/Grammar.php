...
namespace Laravel\Schema\Grammars;

use RuntimeException;
use Doctrine\DBAL\Types\Type;
use Laravel\Support\Fluent;
...
use Laravel\Schema\Blueprint;
use Laravel\Grammar as BaseGrammar;
...
abstract class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \Laravel\Schema\Blueprint  $blueprint
     * @param  \Laravel\Support\Fluent  $command
     ...
     * @param  string  $sql
     * @param  \Laravel\Schema\Blueprint  $blueprint
     * @param  \Laravel\Support\Fluent  $column
     * @return string
     */
     ...
     * @param  \Laravel\Schema\Blueprint  $blueprint
     * @param  string  $name
     * @return \Laravel\Support\Fluent|null
     */
     ...
     *
     * @param  \Doctrine\DBAL\Schema\Table  $table
     * @param  \Laravel\Support\Fluent  $fluent
